...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtToken != null && jwtUtils.validate(jwtToken)) {
                ...
                UserDetails userDetails = loadUserByPublicId(publicId);
    ...
    private UserDetails loadUserByPublicId(String publicId) {
        return userDetailsService.loadUserByPublicId(publicId);
    }
}
